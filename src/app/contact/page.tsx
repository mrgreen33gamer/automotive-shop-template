...
// Redline Auto Care — Contact Page (unique build, not just a form import)
...
// ── Service options ────────────────────────────────────────────────────────────
const SERVICES = [
  'Oil Change & Maintenance', 'Brake Repair', 'Engine Diagnostics',
  'Transmission Service', 'AC & Heating Repair', 'Tire Service & Alignment',
  'Fleet Account Inquiry', 'Other / Not Sure',
];
...
const faq = [
  {
    ...
    answer: "Call us directly at (615) 900-6400. We answer during business hours, 7 days a week isn't standard for us, but same-day appointments usually are — call or use the form below and we'll get you booked.",
  },
  {
    question: 'How quickly can I get an appointment?',
    answer: "Same-day appointments are available most weekdays. We'll give you an honest window when you call — not a vague all-day estimate.",
  },
  {
    question: 'Do you charge for the diagnostic visit?',
    answer: 'We charge a standard diagnostic fee, which is waived when you proceed with the repair. We\'ll confirm the amount when you schedule.',
  },
  {
    question: 'Do you work on fleet or small business vehicles?',
    answer: 'Yes — we service local delivery, rideshare, small business, and municipal fleets. See our Fleet Accounts page or mention it in the form below for volume pricing and priority scheduling.',
  },
  {
    question: 'What areas do you serve?',
    answer: 'Franklin, Brentwood, Nashville, Spring Hill, Murfreesboro, Cool Springs, and most of the Middle Tennessee commuter corridor. Call us — we probably cover your area.',
  },
  {
    question: 'How do I know if I need a repair or a bigger fix?',
    answer: "Our tech will tell you honestly after the diagnosis. If a bigger repair is really the better long-term call, we'll show you the numbers and let you decide — we never push work you don't need.",
  },
];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch('/api/submitContact', {
        ...
        body: JSON.stringify({
          ...formData, urgent, cityName: 'Franklin', slug: 'contact',
  ...
  return (
    <main className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroInner}>
          ...
          <motion.h1 className={styles.heroTitle}
            ...
            Let&apos;s Get Your<br />
            <span className={styles.heroAccent}>Vehicle Fixed</span>
          </motion.h1>
        ...
        <div className={styles.mainInner}>
          ...
          <div className={styles.leftCol}>
            ...
            <div className={styles.infoCards}>
              {[
                ...
                },
                {
                  ...
                  label:     'Email',
                  value:     'hello@redlineautocare.com',
                  href:      'mailto:hello@redlineautocare.com',
                ...
                },
                {
                  ...
                  label:     'Address',
                  value:     '615 Mallory Ln, Franklin TN 37067',
                  href:      'https://maps.google.com/?q=615+Mallory+Ln+Franklin+TN+37067',
                ...
                },
                {
                  ...
                  label:     'Hours',
                  value:     'Mon–Fri 7am–6pm · Sat 8am–2pm · Sun Closed',
                  href:      null,
                  eventType: null,
                  eventLabel: null,
                },
            ...
            <div className={styles.trustBlock}>
              <p className={styles.trustHeading}>Why drivers choose Redline</p>
              {[
                'Flat-rate pricing — written quote before we start',
                '3-year / 36,000-mile warranty on every repair',
                'ASE Certified Master Technicians only',
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successCard}
                  ...
                  <p className={styles.successText}>
                    A Redline Auto Care advisor will reach out shortly — usually within one business day. For urgent needs, call us at{' '}
                    <a href="tel:+16159006400">(615) 900-6400</a>.
                  </p>
                ...
                <motion.div key="form" className={styles.formCard}
                  ...
                  >
                    ...
                    {urgent
                      ...
                      : 'Mark as urgent — vehicle isn\'t safe to drive'}
                  </button>
                  ...
                  <form className={styles.form} onSubmit={handleSubmit} noValidate>
                    ...
                    <div className={styles.row}>
                      ...
                      <div className={styles.field}>
                        ...
                        <input id="c-phone" className={styles.input} name="phone" type="tel"
                          placeholder="(615) 555-0100" required value={formData.phone} onChange={handleChange} />
                      </div>
                    </div>
                    ...
                    <div className={styles.field}>
                      ...
                      <input id="c-address" className={styles.input} name="address" type="text"
                        placeholder="123 Main St, Franklin TN" value={formData.address} onChange={handleChange} />
                    </div>
                    ...
                    <div className={styles.field}>
                      ...
                      <textarea id="c-message" className={`${styles.input} ${styles.textarea}`}
                        ...
                        placeholder="What's happening? When did it start? Any warning lights or noises?"
      ...
      <div className={styles.faqWrap}>
        <FAQ cityName="Franklin" faq={faq} title="Common Questions Before You Call" />
      </div>

      {/* ── CTA Banner ───────────────────────────────────────────────────── */}
      <CTABanner
        headline="Need Us Right Now?"
        subline="Call (615) 900-6400 — same-day appointments available most weekdays across Middle Tennessee."
        primaryText="Call (615) 900-6400"
        primaryLink="tel:+16159006400"
        secondaryText="Send a Text"
        secondaryLink="sms:+16159006400"
      />
