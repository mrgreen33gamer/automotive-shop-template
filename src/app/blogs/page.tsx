    ...
    <main className={styles.page}>
      ...
      <section className={styles.pageHeader}>
        ...
        >
          ...
          <h1 className={styles.pageTitle}>Redline Auto Care - Blog Center</h1>
          <p className={styles.pageSubtitle}>
            Real talk and useful tips for Middle Tennessee drivers — vehicle maintenance, repair costs, and more.
          </p>
        </motion.div>
      </section>
        ...
        <div className={styles.container}>
          ...
          >
            <p className={styles.blogCTAHeading}>
              Need reliable auto repair in Middle Tennessee?
            </p>
            <p className={styles.blogCTABody}>
              We've been keeping Franklin-area drivers safely on the road with honest, ASE-certified repair and maintenance since 2012. Free estimate, no obligations.
            </p>
