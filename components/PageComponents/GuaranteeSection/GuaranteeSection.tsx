...
const DEFAULT_GUARANTEES: Guarantee[] = [
  ...
  {
    icon: faShieldHalved,
    title: "3-Year / 36,000-Mile Warranty",
    description:
      "Every repair we perform is covered nationwide for 3 years or 36,000 miles — parts and labor. If it fails, we fix it at no charge.",
  },
  {
    icon: faRotateLeft,
    title: "Satisfaction Guarantee",
    description:
      "Not satisfied with our work? We'll make it right — or refund you. We stand behind every job, no exceptions.",
  },
  {
    icon: faCertificate,
    title: "ASE Certified Master Technicians",
    description:
      "Every tech who works on your vehicle is ASE certified — Redline is an ASE Blue Seal of Excellence Shop. No apprentices working alone — ever.",
  },
  {
      ...
      <div className={styles.container}>
        ...
        <div className={styles.leftCol}>
          ...
          <p className={styles.body}>
            Every auto repair shop in Middle Tennessee makes promises. We back ours in writing — with flat-rate pricing, ASE certified technicians, and a 3-year / 36,000-mile warranty on every repair we touch.
          </p>
          <Link
            href={ctaLink}
          ...
          <div className={styles.ratingRow}>
            ...
            <span className={styles.ratingText}>4.9 · 850+ verified Google reviews</span>
          </div>
        </div>
