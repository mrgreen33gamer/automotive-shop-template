...
const FIELDS = [
  ...
  { num: '02', id: 'v3-phone',   name: 'phone',   type: 'tel',   label: 'Phone Number',  icon: faPhone,       placeholder: '(615) 555-0100',        required: true  },
  { num: '03', id: 'v3-email',   name: 'email',   type: 'email', label: 'Email Address', icon: faEnvelope,    placeholder: 'jane@example.com',       required: true  },
  { num: '04', id: 'v3-address', name: 'address', type: 'text',  label: 'Service Address',icon: faLocationDot, placeholder: '123 Main St, Franklin TN', required: false },
];
    ...
    <div className={styles.root}>
      <div className={styles.card}>
        ...
        <div className={styles.topRail}>
          ...
          <span className={styles.railLabel}>{cityName}, TN · Free Estimate</span>
        </div>
                ...
                <motion.div className={styles.numberedField}
                  ...
                  <div className={styles.fieldInner}>
                    ...
                    <textarea id="v3-message" name="message" className={`${styles.input} ${styles.textarea}`}
                      placeholder="What's happening? Strange noise? Warning light? Won't start?" rows={3}
