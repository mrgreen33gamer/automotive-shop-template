...
const SERVICES = [
  { icon: faFan,             label: 'Oil Change',        sub: 'Routine oil change & maintenance' },
  { icon: faFire,            label: 'Brake Repair',      sub: 'Squeaking, grinding, soft pedal' },
  { icon: faWrench,          label: 'Engine Diagnostics', sub: 'Check engine light, rough running' },
  { icon: faFilter,          label: 'Transmission',      sub: 'Slipping, fluid service, diagnostics' },
  { icon: faThermometerHalf, label: 'AC / Heating',      sub: 'Blowing warm, weak airflow' },
  { icon: faWind,            label: 'Tire Service',      sub: 'Rotation, replacement, alignment' },
  { icon: faBolt,            label: 'Other',             sub: 'Something else — tell us below' },
];
      ...
      <div className={styles.container}>
        ...
        {!submitted && (
          <motion.div className={styles.header}
            ...
            <span className={styles.eyebrow}>Free Estimate · {cityName}, TN</span>
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successState}
                  ...
                  <p className={styles.successText}>
                    A licensed Redline Auto Care tech will reach out about your <strong>{selectedService}</strong> service.
                  </p>
                  <div className={styles.successSummary}>
                    ...
                    <div className={styles.summaryRow}><span>Location</span><span>{cityName}, TN</span></div>
                  </div>
                </motion.div>
