        ...
        <div className={styles.card}>
          ...
          <div className={styles.leftPanel}>
            <div className={styles.panelInner}>
              ...
              <span className={styles.quoteAttrib}>— Redline Auto Care, Franklin TN</span>

              <div className={styles.panelStats}>
                {[
                  { val: '12,000+', lbl: 'Vehicles Served' },
                  { val: '4.9★',    lbl: 'Google Rating' },
                  { val: '13+',     lbl: 'Years Local' },
                ].map(s => (
              ...
              <div className={styles.panelBadges}>
                {['Same-Day Available', '3-Yr/36k Warranty', 'No Contracts', 'ASE Certified'].map(b => (
                  ...
                  <form className={styles.form} onSubmit={handleSubmit} noValidate>
                    ...
                    <div className={styles.field}>
                      ...
                      <textarea id="v2r-message" className={`${styles.input} ${styles.textarea}`}
                        name="message" placeholder="What's happening with your vehicle?" rows={3}
