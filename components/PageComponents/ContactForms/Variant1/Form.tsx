...
const SERVICES = [
  { icon: faFan,             label: 'Oil Change' },
  { icon: faFire,            label: 'Brake Repair' },
  { icon: faWrench,          label: 'Engine Diagnostics' },
  { icon: faFilter,          label: 'Transmission' },
  { icon: faThermometerHalf, label: 'AC / Heating' },
  { icon: faWind,            label: 'Tire Service' },
  { icon: faBolt,            label: 'Other' },
];
...
const TRUST_CHIPS = [
  ...
  { icon: faShieldHalved, text: 'ASE Certified' },
  { icon: faStar,         text: '4.9★ · 850+ reviews' },
];
            ...
            {submitted ? (
              <motion.div key="success" className={styles.successState}
                ...
                <p className={styles.successText}>
                  A licensed Redline Auto Care technician will reach out shortly. Keep an eye on your inbox and phone.
                </p>
                ...
                <form className={styles.form} onSubmit={handleSubmit} noValidate>
                  ...
                  <div className={styles.submitRow}>
                    ...
                    <div className={styles.altContact}>
                      ...
                      <span>Need help now?{' '}
                        <a href="tel:+16159006400"
                          onClick={() => trackEvent({ eventType: 'phone_click', elementLabel: 'Call (615) 900-6400', section: 'ContactForm-V1' })}>
                          Call (615) 900-6400
                        </a>
                      </span>
                    </div>
