...
const MapLocalTips: React.FC<MapLocalTipsProps> = ({ cityName }) => {
  ...
  return (
    <section
      ...
      aria-label={`Local Map for ${cityName}, TN`}
    >
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <h2 className={styles.title}>
            Find Us in <em>{cityName}</em>, TN
          </h2>
          <p className={styles.subtitle}>
            Based in Franklin — serving {cityName} and all surrounding communities across Middle Tennessee.
          </p>
        </div>
        ...
        <div className={`${styles.mapCard} ${loaded ? styles.mapLoaded : ""}`}>
          ...
          <iframe
            ...
            src={`https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d10000!2d-86.8689!3d35.9251!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x86454c7a6a8b7b79%3A0x7d7b8b8a8b8b8b8b!2s${encodeURIComponent(
              cityName + ", TN"
