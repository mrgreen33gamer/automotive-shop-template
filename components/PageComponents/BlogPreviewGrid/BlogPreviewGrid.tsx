...
const BlogPreviewGrid: React.FC<BlogPreviewGridProps> = ({
  title       = 'Auto Care Tips & Insights',
  subtitle    = 'Practical advice for Middle Tennessee drivers — when to repair, when to replace, and how to keep your vehicle running longer.',
  posts,
  count       = 4,
  viewAllLink = '/blogs',
