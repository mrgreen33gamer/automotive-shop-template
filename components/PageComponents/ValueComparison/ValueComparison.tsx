...
const DEFAULT_ROWS: ComparisonRow[] = [
  ...
  { feature: '3-Yr / 36,000-mile warranty',             us: true,  others: false },
  { feature: 'Same-day appointments',                  us: true,  others: 'Sometimes' },
  { feature: 'No service contracts required',          us: true,  others: false },
  { feature: 'ASE certified technicians',               us: true,  others: true },
  { feature: 'Upfront quote before work begins',       us: true,  others: false },
  { feature: 'All major makes serviced',                us: true,  others: 'Sometimes' },
...
export default function ValueComparison({ rows = DEFAULT_ROWS, title = 'Redline vs. The Other Guys' }: ValueComparisonProps) {
  return (
