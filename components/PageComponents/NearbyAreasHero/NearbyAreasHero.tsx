...
export default function NearbyAreasHero({
  ...
  const displayHeadline = headline ?? `Auto Repair in ${cityName}, TN`;
  const displayDesc     = description ??
    `Redline Auto Care provides fast, reliable auto repair and maintenance to ${cityName} and all surrounding communities. ASE certified technicians, flat-rate pricing, 3-year / 36,000-mile warranty on every job.`;
    ...
    <section className={styles.section}>
      ...
      <div className={styles.container}>
        ...
        >
          ...
          <a href="tel:+16159006400" className={styles.phoneBtn}>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
